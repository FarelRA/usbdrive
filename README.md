...
# Force UDC (UDC gadget, read-write only)
usbdrive mount -f udc /sdcard/ubuntu.iso
```
...
**Backend options:** `configfs` (modern), `sysfs` (legacy), `udc` (UDC gadget)
